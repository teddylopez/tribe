...
export const LIST_TOP_SELLERS_REQUEST = "LIST_TOP_SELLERS_REQUEST";
export const LIST_TOP_SELLERS_SUCCESS = "LIST_TOP_SELLERS_SUCCESS";
export const LIST_TOP_SELLERS_FAIL = "LIST_TOP_SELLERS_FAIL";
